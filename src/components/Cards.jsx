      ...
      <div className="flex flex-wrap justify-center gap-10 p-4">
        ...
        <div className="bg-sky-600 shadow-2xl rounded-3xl md:py-8 max-w-sm md:max-w-lg p-6 hover:shadow-xl transition-shadow">
          ...
          <div className=" w-64 md:w-80 py-1">
            <h1 className="text-2xl md:text-6xl w-12 md:w-28 py-2 px-4 md:py-5 md:px-5 md:pl-8 md:pr-8 text-sky-600 bg-white rounded-xl md:rounded-3xl font-bold">1.</h1>

            <div className="mt-4 md:pt-20">
              <div className="w-full h-1 bg-blue-300 rounded-full">
                <div className="h-1 bg-white rounded-full w-1/2"></div>
              </div>
            </div>

            <p className='title text-2xl md:text-4xl pt-6 md:pt-10 font-bold text-white '>
              Choose a Free Resume Template
            </p>
            <p className="text-gray-300 pt-1 text-sm md:text-xl mt-2">
        ...
        <div className="bg-gray-100 shadow-lg rounded-3xl max-w-sm p-6 hover:shadow-xl transition-shadow">
          ...
          <div className="w-64 md:w-80 py-1">
            ...
            <p className="title text-2xl md:text-4xl pt-6 md:pt-36 font-bold text-gray-800">
