    ...
    return (
        <div className="relative inline-block w-full h-5 mt-5 text-left">
            ...
            <button
                ...
                className="inline-flex justify-center w-full text-left py-2 text-sm font-semibold  text-gray-7 bg-white border-2 border-gray-300 rounded-md hover:bg-gray-100 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-500"
            > <span className=" relative right-5"> {props.heading} </span> 
                <svg
